...
setwd("/home/loibldav/Git/downscaling/Stationsdaten/Maidantal")

#Defining the coordinates of the respective field station
x_coordinate <- 66.54    #Maidan Tal
y_coordinate <- 38.40

SpatialPoints(cbind(x_coordinate,y_coordinate)) 

name_station <- "Maidan Tal"
time_difference<- "+ 6h"
...
temperature <- read.table("HM_data_2014-09-29", sep=",", dec=".", header=T)  
...
ERA_T<-brick("/media/loibldav/TOSHIBA EXT/CLIMATE DATA/ERA-Interim/Tien-Shan/Anika Pinzer - downscaling/2mTemperature_grib2netcdf-atls19-a562cefde8a29a7288fa0b8b7f9413f7-QxQ5UT.nc")
...
ERA_GPH<-brick("/media/loibldav/TOSHIBA EXT/CLIMATE DATA/ERA-Interim/Tien-Shan/Anika Pinzer - downscaling/Geopotentialheight_grib2netcdf-atls19-a562cefde8a29a7288fa0b8b7f9413f7-f40UOF.nc")
...
ERA_TCWV<-brick("/media/loibldav/TOSHIBA EXT/CLIMATE DATA/ERA-Interim/Tien-Shan/Anika Pinzer - downscaling/TCWV_grib2netcdf-atls04-a562cefde8a29a7288fa0b8b7f9413f7-i6r9so.nc")
...
ERA_UCW<-brick("/media/loibldav/TOSHIBA EXT/CLIMATE DATA/ERA-Interim/Tien-Shan/Anika Pinzer - downscaling/UCW_grib2netcdf-atls17-a562cefde8a29a7288fa0b8b7f9413f7-BusyaH.nc")
...
ERA_VCW<-brick("/media/loibldav/TOSHIBA EXT/CLIMATE DATA/ERA-Interim/Tien-Shan/Anika Pinzer - downscaling/VCW_grib2netcdf-atls06-a562cefde8a29a7288fa0b8b7f9413f7-AWDI2T.nc")
...
ERA_MSLP<-brick("/media/loibldav/TOSHIBA EXT/CLIMATE DATA/ERA-Interim/Tien-Shan/Anika Pinzer - downscaling/MSLP_grib2netcdf-atls15-a562cefde8a29a7288fa0b8b7f9413f7-W2M6nq.nc")
...
ERA_TCC<-brick("/media/loibldav/TOSHIBA EXT/CLIMATE DATA/ERA-Interim/Tien-Shan/Anika Pinzer - downscaling/TCC_grib2netcdf-atls12-a562cefde8a29a7288fa0b8b7f9413f7-A0rdO6.nc")
...
plot(date, data_all_norm_0$Tdiff, main = paste(name_station, "- RG 0h", time_difference), xlab="date", ylab="Tdiff [K]", ylim=c(-20,30))
...
plot(date, data_all_norm_6$Tdiff, main = paste(name_station, "- RG 6h", time_difference), xlab="date", ylab="Tdiff [K]", ylim=c(-20,30))
...
plot(date, data_all_norm_12$Tdiff, main = paste(name_station, "- RG 12h", time_difference), xlab="date", ylab="Tdiff [K]", ylim=c(-20,30))
...
plot(date, data_all_norm_18$Tdiff, main = paste(name_station, "- RG 18h", time_difference), xlab="date", ylab="Tdiff [K]", ylim=c(-20,30))
...
plot(date, df_data_all_norm$Tdiff, main = paste(name_station, "- RG data_all", time_difference), xlab="date", ylab="Tdiff [K]", ylim=c(-20,30))
...
date<- ISOdate(data_all_norm_0$y, data_all_norm_0$m, data_all_norm_0$d, data_all_norm_0$h)
plot(date, cv_results_0h, main = paste(name_station, "- CV 0h", time_difference), xlab="date", ylab="Tdiff [K]", col="violetred3", ylim=c(-20,30))
...
date<- ISOdate(data_all_norm_6$y, data_all_norm_6$m, data_all_norm_6$d, data_all_norm_6$h)
plot(date, cv_results_6h, main = paste(name_station, "- CV 6h", time_difference), xlab="date", ylab="Tdiff [K]", col="darkcyan", ylim=c(-20,30))
...
date<- ISOdate(data_all_norm_12$y, data_all_norm_12$m, data_all_norm_12$d, data_all_norm_12$h)
plot(date, cv_results_12h, main = paste(name_station, "- CV 12h", time_difference), xlab="date", ylab="Tdiff [K]", col="olivedrab3", ylim=c(-20,30))
...
date<- ISOdate(data_all_norm_18$y, data_all_norm_18$m, data_all_norm_18$d, data_all_norm_18$h)
plot(date, cv_results_18h, main = paste(name_station, "- CV 18h", time_difference), xlab="date", ylab="Tdiff [K]", col="darkorange2", ylim=c(-20,30))
...
points(date, T_Station_H_0h, col="darkolivegreen")
...
legend("topright", legend=c(paste("T_ERA"), paste("T_Station_H"), paste("T_Station")), 
       lty=c(1,1,1), lwd=c(2.5,2.5,2.5), col=c("black","darkolivegreen","brown"),bty='n', horiz=FALSE, cex=0.7)
...
points(date, T_Station_H_6h, col="darkolivegreen")
...
points(date, T_Station_H_12h, col="darkolivegreen")
...
points(date, T_Station_H_18h, col="darkolivegreen")
